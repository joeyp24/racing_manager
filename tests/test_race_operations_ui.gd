...
func _initialize() -> void:
	...
	if tower_card.size.y < 250.0 or tower_card.global_position.y + tower_card.size.y > page_bottom or broadcast_scroll.global_position.y + broadcast_scroll.size.y > page_bottom or playback.global_position.y + playback.size.y > page_bottom:
