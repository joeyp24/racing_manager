...
CHECKS = (
    ...
    (
        "AI race operations tests",
        ("--headless", "--path", ".", "--script", "tests/test_ai_race_operations.gd"),
    ),
    (
    ...
    (
        "Career decision-center model tests",
        (
            "--headless",
            "--path",
            ".",
            "--script",
            "tests/test_career_decision_center.gd",
        ),
    ),
    (
